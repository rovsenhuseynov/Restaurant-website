    ...
    <div className="discover-menu">
      <div className="discover-menu__container">
        <div className="discover-menu__Images">
          <img src={lovel_img_1} alt="img of Azerbaijani cuisine" className="discover-menu__Image"/>
          <img src={lovel_img_2} alt="img of Azerbaijani cuisine" className="discover-menu__Image"/>
          <img src={lovel_img_3} alt="img of Azerbaijani cuisine" className="discover-menu__Image"/>
          <img src={lovel_img_4} alt="img of Azerbaijani cuisine" className="discover-menu__Image"/>
        </div>
